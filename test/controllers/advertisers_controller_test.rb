...
class AdvertisersControllerTest < ActionController::TestCase
  ...
  test "should create advertiser" do
    assert_difference('Advertiser.count') do
      post :create, advertiser: { company_name: @advertiser.company_name, contact_person: @advertiser.contact_person, website: @advertiser.website }
    end
  ...
  test "should update advertiser" do
    patch :update, id: @advertiser, advertiser: { company_name: @advertiser.company_name, contact_person: @advertiser.contact_person, website: @advertiser.website }
    assert_redirected_to advertiser_path(assigns(:advertiser))
  end
